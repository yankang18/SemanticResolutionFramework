package umbc.ebiquity.kang.ontologyinitializator.similarity.impl;
...
public class EqualSemanticRootBoostingLabelSimilarity implements ILabelSimilarity {
	...
	public EqualSemanticRootBoostingLabelSimilarity(IWordListSimilarity wordListSimilarity) {
		this._wordListSimilarity = wordListSimilarity;
	}
	
	public EqualSemanticRootBoostingLabelSimilarity(IWordListSimilarity wordListSimilarity, boolean penalize) {
		this._wordListSimilarity = wordListSimilarity;
