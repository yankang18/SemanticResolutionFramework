...
import umbc.ebiquity.kang.webpageparser.LeafNodeDetermintor;
import umbc.ebiquity.kang.webpageparser.WebPage;
import umbc.ebiquity.kang.webpageparser.WebPagePaths;

public class WebPagePathsImpl implements WebPagePaths {
	...
	private LeafNodeDetermintor leafNodeDetermintor;

	WebPagePathsImpl(WebPage webPage) {
		webPagePathList = new ArrayList<WebPathPath>();
		tagCounterMapper = new HashMap<String, Integer>();
		this.webPage = webPage;
		this.baseURL = webPage.getWebPageDocument().baseUri();
		this.isConstructed = false;
		leafNodeDetermintor = new LeafNodeDetermintorImpl();
	}
	...
	private void appendWebPagePathNode(WebPathPath path, Element elem) {
...
//	}
	 ...
	 */
	public List<WebPathPath> getPaths() {
