...
public class Concept2OntClassMappingPairLookUpTest {
	...
	public static void LoadDataFromFile() throws IOException {
		...
		IManufacturingLexicalMappingRepository _MLReposiory = ManufacturingLexicalMappingRepositoryFactory.createManufacturingLexiconRepository();
